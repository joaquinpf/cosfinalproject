...
<LI><A HREF="Input.jsp?method=10" TARGET="inputs"> getChatService()</A></LI>
<LI><A HREF="Input.jsp?method=13" TARGET="inputs"> login(wschat.Auth)</A></LI>
<LI><A HREF="Input.jsp?method=22" TARGET="inputs"> logout(wschat.Auth)</A></LI>
